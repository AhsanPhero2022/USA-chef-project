        ...
        <ReactToPrint
          trigger={() => (
            <button className="btn btn-danger py-2">
              ...
              <span> Download or Print PDF </span>
            </button>
          )}
          content={() => ref.current}
        ></ReactToPrint>
          ...
          <Row>
            <Col lg={6}>
              ...
              <p>
                ...
                console warning. After we specify validation patterns, we will
                set App. defaultProps.
              </p>
            </Col>
            <Col lg={6}>
              <div className=" text-center">
          ...
          <Row>
            <Col lg={6}>
              ...
              <p>
                ...
                outside of a web browser. It is built on top of the V8
                JavaScript engine and allows developers to write server-side
                code using JavaScript. Node.js provides a set of built-in
                modules for handling file I/O, networking, and other
                system-level tasks.
                <br />
                Express.js is a web application framework built on top of
                Node.js. It provides a set of APIs and tools for building web
                applications and APIs. Express.js allows developers to handle
                HTTP requests, define routes, and interact with databases and
                other third-party services.
                <br /> In summary: Node.js provides the runtime environment for
                executing JavaScript code, while Express.js provides the
                framework for building web applications and APIs on top of
                Node.js.
              </p>
            </Col>
            <Col lg={6}>
          ...
          <Row>
            <Col lg={6}>
              ...
              <p>
                ...
                abstract away complex logic from the component and reuse it
                across multiple components. A custom hook can use other hooks
                and allows you to share stateful logic between multiple
                components.
                <br />
                ...
                services.
                <br />
                <br /> Creating a custom hook helps in reducing code
                duplication, improving code readability, and making code
                maintainable. By creating a custom hook, you can extract the
                common logic from the components, test it independently, and
